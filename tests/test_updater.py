...
class FakeResponse:
    payload = {
        ...
        "assets": [
            {
                "name": "ReplyRightSetup-v0.1.2.exe",
                "browser_download_url": "https://example.com/ReplyRightSetup-v0.1.2.exe",
            },
        ],
    }
...
def test_update_check_records_available_release() -> None:
    ...
    assert status["asset_url"] == "https://example.com/ReplyRightSetup-v0.1.2.exe"
