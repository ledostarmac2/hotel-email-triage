...
|---|---|---|---|
| Prepare `v0.5.8` release after installer extraction scanner noise | Codex | Assigned to Codex | Hard-block payload `.env`, warn on broader payload scanner noise, tag/push `v0.5.8`, and watch release. |
